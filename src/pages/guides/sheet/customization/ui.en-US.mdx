...
In Univer, both the top toolbar menu and the context menu can be extended by writing plugins. The following will introduce how to use `IMenuService` in the dependency injection system to register menu items.
