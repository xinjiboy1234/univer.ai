...
If you can't wait to experience Univer, please select the following document to get started quickly:

<Cards>
  <Card
    icon="📊 "
    title="Univer Sheet"
    href="/guides/sheet/getting-started/quickstart"
  />
  <Card
    icon="📝 "
    title="Univer Doc"
    href="/guides/doc/getting-started/quickstart"
  />
  <Card
    icon="📽️ "
    title="Univer Slide"
    href="/guides/slide/getting-started/quickstart"
  />
</Cards>
